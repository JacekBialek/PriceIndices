...
We can save the model on the disk, load it and use it at any time:

```{r,eval=FALSE}
#Set a temporal directory as a working directory
wd<-tempdir()
setwd(wd)
...
We can use the model for COICOP predictions
