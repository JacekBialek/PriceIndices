...
```{r}
dataset <- generate(
  pmi = c(1.02, 1.03, 1.04), psigma = c(0.05, 0.09, 0.02),
...
```{r}
data2 <- data_matching(dataMATCH,
  start = "2018-12", end = "2019-02",
...
``` {r}
case1 <- price_indices(milk,
  start = "2018-12", end = "2019-12",
  formula = "fisher", interval = TRUE
)
case2 <- final_index(milk,
  start = "2018-12", end = "2019-12",
  formula = "fisher",
  outlets = TRUE,
  aggr = "laspeyres",
...
compare_indices_list(
  data = list(case1, case2),
  names = c(
    "Fisher without aggregation",
