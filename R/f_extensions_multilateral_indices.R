      ...
      if (start <= wend) {
        ...
        if (splice == "window") {
          set <-
            c(
              set,
              set[length(set)] * geks(data, tT, t, wstart = tT, window) / geks(data, tT, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "half") {
          set <-
            c(
              set,
              set[length(set)] * geks(data, th, t, wstart = tT, window) / geks(data, th, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "mean") {
          ...
          for (m in 1:(window - 1)) {
            ...
            tm <- substr(tm, 0, 7)
            var <-
              var * geks(data, tm, t, wstart = tT, window) / geks(data, tm, t1,
                wstart =
                  tT1, window
              )
          }
        ...
        if (splice == "window_published") {
          set <-
            c(set, set[length(set) + 1 - (window - 1)] * geks(data, tT, t,
              wstart =
                tT, window
            ))
        }
        if (splice == "half_published") {
          set <-
            c(set, set[length(set) + 1 - floor(window / 2)] * geks(data, th, t,
              wstart =
                tT, window
            ))
        }
      ...
      if (start <= wend) {
        ...
        if (splice == "window") {
          set <-
            c(
              set,
              set[length(set)] * geksw(data, tT, t, wstart = tT, window) / geksw(data, tT, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "half") {
          set <-
            c(
              set,
              set[length(set)] * geksw(data, th, t, wstart = tT, window) / geksw(data, th, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "mean") {
          ...
          for (m in 1:(window - 1)) {
            ...
            tm <- substr(tm, 0, 7)
            var <-
              var * geksw(data, tm, t, wstart = tT, window) / geksw(data, tm, t1,
                wstart =
                  tT1, window
              )
          }
        ...
        if (splice == "window_published") {
          set <-
            c(set, set[length(set) + 1 - (window - 1)] * geksw(data, tT, t,
              wstart =
                tT, window
            ))
        }
        if (splice == "half_published") {
          set <-
            c(set, set[length(set) + 1 - floor(window / 2)] * geksw(data, th, t,
              wstart =
                tT, window
            ))
        }
      ...
      if (start <= wend) {
        ...
        if (splice == "window") {
          set <-
            c(
              set,
              set[length(set)] * geksj(data, tT, t, wstart = tT, window) / geksj(data, tT, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "half") {
          set <-
            c(
              set,
              set[length(set)] * geksj(data, th, t, wstart = tT, window) / geksj(data, th, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "mean") {
          ...
          for (m in 1:(window - 1)) {
            ...
            tm <- substr(tm, 0, 7)
            var <-
              var * geksj(data, tm, t, wstart = tT, window) / geksj(data, tm, t1,
                wstart =
                  tT1, window
              )
          }
        ...
        if (splice == "window_published") {
          set <-
            c(set, set[length(set) + 1 - (window - 1)] * geksj(data, tT, t,
              wstart =
                tT, window
            ))
        }
        if (splice == "half_published") {
          set <-
            c(set, set[length(set) + 1 - floor(window / 2)] * geksj(data, th, t,
              wstart =
                tT, window
            ))
        }
      ...
      if (start <= wend) {
        ...
        if (splice == "window") {
          set <-
            c(
              set,
              set[length(set)] * ccdi(data, tT, t, wstart = tT, window) / ccdi(data, tT, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "half") {
          set <-
            c(
              set,
              set[length(set)] * ccdi(data, th, t, wstart = tT, window) / ccdi(data, th, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "mean") {
          ...
          for (m in 1:(window - 1)) {
            ...
            tm <- substr(tm, 0, 7)
            var <-
              var * ccdi(data, tm, t, wstart = tT, window) / ccdi(data, tm, t1,
                wstart =
                  tT1, window
              )
          }
        ...
        if (splice == "window_published") {
          set <-
            c(set, set[length(set) + 1 - (window - 1)] * ccdi(data, tT, t,
              wstart =
                tT, window
            ))
        }
        if (splice == "half_published") {
          set <-
            c(set, set[length(set) + 1 - floor(window / 2)] * ccdi(data, th, t,
              wstart =
                tT, window
            ))
        }
      ...
      if (start <= wend) {
        ...
        if (splice == "window") {
          set <-
            c(
              set,
              set[length(set)] * gk(data, tT, t, wstart = tT, window) / gk(data, tT, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "half") {
          set <-
            c(
              set,
              set[length(set)] * gk(data, th, t, wstart = tT, window) / gk(data, th, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "half_published") {
          set <-
            c(set, set[length(set) + 1 - floor(window / 2)] * gk(data, th, t,
              wstart =
                tT, window
            ))
        }
      ...
      if (start <= wend) {
        ...
        if (splice == "window") {
          set <-
            c(
              set,
              set[length(set)] * tpd(data, tT, t, wstart = tT, window) / tpd(data, tT, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "half") {
          set <-
            c(
              set,
              set[length(set)] * tpd(data, th, t, wstart = tT, window) / tpd(data, th, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "mean") {
          ...
          for (m in 1:(window - 1)) {
            ...
            tm <- substr(tm, 0, 7)
            var <-
              var * tpd(data, tm, t, wstart = tT, window) / tpd(data, tm, t1,
                wstart =
                  tT1, window
              )
          }
        ...
        if (splice == "half_published") {
          set <-
            c(set, set[length(set) + 1 - floor(window / 2)] * tpd(data, th, t,
              wstart =
                tT, window
            ))
        }
      ...
      if (start <= wend) {
        ...
        if (splice == "window") {
          set <-
            c(
              set,
              set[length(set)] * utpd(data, tT, t, wstart = tT, window) / utpd(data, tT, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "half") {
          set <-
            c(
              set,
              set[length(set)] * utpd(data, th, t, wstart = tT, window) / utpd(data, th, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "mean") {
          ...
          for (m in 1:(window - 1)) {
            ...
            tm <- substr(tm, 0, 7)
            var <-
              var * utpd(data, tm, t, wstart = tT, window) / utpd(data, tm, t1,
                wstart =
                  tT1, window
              )
          }
        ...
        if (splice == "half_published") {
          set <-
            c(set, set[length(set) + 1 - floor(window / 2)] * utpd(data, th, t,
              wstart =
                tT, window
            ))
        }
      ...
      if (start <= wend) {
        ...
        if (splice == "window") {
          set <-
            c(
              set,
              set[length(set)] * wgeks(data, tT, t, wstart = tT, window) / wgeks(data, tT, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "half") {
          set <-
            c(
              set,
              set[length(set)] * wgeks(data, th, t, wstart = tT, window) / wgeks(data, th, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "mean") {
          ...
          for (m in 1:(window - 1)) {
            ...
            tm <- substr(tm, 0, 7)
            var <-
              var * wgeks(data, tm, t, wstart = tT, window) / wgeks(data, tm, t1,
                wstart =
                  tT1, window
              )
          }
        ...
        if (splice == "window_published") {
          set <-
            c(set, set[length(set) + 1 - (window - 1)] * wgeks(data, tT, t,
              wstart =
                tT, window
            ))
        }
        if (splice == "half_published") {
          set <-
            c(set, set[length(set) + 1 - floor(window / 2)] * wgeks(data, th, t,
              wstart =
                tT, window
            ))
        }
      ...
      if (start <= wend) {
        ...
        if (splice == "window") {
          set <-
            c(
              set,
              set[length(set)] * geksl(data, tT, t, wstart = tT, window) / geksl(data, tT, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "half") {
          set <-
            c(
              set,
              set[length(set)] * geksl(data, th, t, wstart = tT, window) / geksl(data, th, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "mean") {
          ...
          for (m in 1:(window - 1)) {
            ...
            tm <- substr(tm, 0, 7)
            var <-
              var * geksl(data, tm, t, wstart = tT, window) / geksl(data, tm, t1,
                wstart =
                  tT1, window
              )
          }
        ...
        if (splice == "window_published") {
          set <-
            c(set, set[length(set) + 1 - (window - 1)] * geksl(data, tT, t,
              wstart =
                tT, window
            ))
        }
        if (splice == "half_published") {
          set <-
            c(set, set[length(set) + 1 - floor(window / 2)] * geksl(data, th, t,
              wstart =
                tT, window
            ))
        }
      ...
      if (start <= wend) {
        ...
        if (splice == "window") {
          set <-
            c(
              set,
              set[length(set)] * wgeksl(data, tT, t, wstart = tT, window) / wgeksl(data, tT, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "half") {
          set <-
            c(
              set,
              set[length(set)] * wgeksl(data, th, t, wstart = tT, window) / wgeksl(data, th, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "mean") {
          ...
          for (m in 1:(window - 1)) {
            ...
            tm <- substr(tm, 0, 7)
            var <-
              var * wgeksl(data, tm, t, wstart = tT, window) / wgeksl(data, tm, t1,
                wstart =
                  tT1, window
              )
          }
        ...
        if (splice == "window_published") {
          set <-
            c(set, set[length(set) + 1 - (window - 1)] * wgeksl(data, tT, t,
              wstart =
                tT, window
            ))
        }
        if (splice == "half_published") {
          set <-
            c(set, set[length(set) + 1 - floor(window / 2)] * wgeksl(data, th, t,
              wstart =
                tT, window
            ))
        }
      ...
      if (start <= wend) {
        ...
        if (splice == "window") {
          set <-
            c(
              set,
              set[length(set)] * geksgl(data, tT, t, wstart = tT, window) / geksgl(data, tT, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "half") {
          set <-
            c(
              set,
              set[length(set)] * geksgl(data, th, t, wstart = tT, window) / geksgl(data, th, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "mean") {
          ...
          for (m in 1:(window - 1)) {
            ...
            tm <- substr(tm, 0, 7)
            var <-
              var * geksgl(data, tm, t, wstart = tT, window) / geksgl(data, tm, t1,
                wstart =
                  tT1, window
              )
          }
        ...
        if (splice == "window_published") {
          set <-
            c(set, set[length(set) + 1 - (window - 1)] * geksgl(data, tT, t,
              wstart =
                tT, window
            ))
        }
        if (splice == "half_published") {
          set <-
            c(set, set[length(set) + 1 - floor(window / 2)] * geksgl(data, th, t,
              wstart =
                tT, window
            ))
        }
      ...
      if (start <= wend) {
        ...
        if (splice == "window") {
          set <-
            c(
              set,
              set[length(set)] * wgeksgl(data, tT, t, wstart = tT, window) / wgeksgl(data, tT, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "half") {
          set <-
            c(
              set,
              set[length(set)] * wgeksgl(data, th, t, wstart = tT, window) / wgeksgl(data, th, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "mean") {
          ...
          for (m in 1:(window - 1)) {
            ...
            tm <- substr(tm, 0, 7)
            var <-
              var * wgeksgl(data, tm, t, wstart = tT, window) / wgeksgl(data, tm, t1,
                wstart =
                  tT1, window
              )
          }
        ...
        if (splice == "window_published") {
          set <-
            c(set, set[length(set) + 1 - (window - 1)] * wgeksgl(data, tT, t,
              wstart =
                tT, window
            ))
        }
        if (splice == "half_published") {
          set <-
            c(set, set[length(set) + 1 - floor(window / 2)] * wgeksgl(data, th, t,
              wstart =
                tT, window
            ))
        }
      ...
      if (start <= wend) {
        ...
        if (splice == "window") {
          set <-
            c(
              set,
              set[length(set)] * geksaqu(data, tT, t, wstart = tT, window) / geksaqu(data, tT, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "half") {
          set <-
            c(
              set,
              set[length(set)] * geksaqu(data, th, t, wstart = tT, window) / geksaqu(data, th, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "mean") {
          ...
          for (m in 1:(window - 1)) {
            ...
            tm <- substr(tm, 0, 7)
            var <-
              var * geksaqu(data, tm, t, wstart = tT, window) / geksaqu(data, tm, t1,
                wstart =
                  tT1, window
              )
          }
        ...
        if (splice == "window_published") {
          set <-
            c(set, set[length(set) + 1 - (window - 1)] * geksaqu(data, tT, t,
              wstart =
                tT, window
            ))
        }
        if (splice == "half_published") {
          set <-
            c(set, set[length(set) + 1 - floor(window / 2)] * geksaqu(data, th, t,
              wstart =
                tT, window
            ))
        }
      ...
      if (start <= wend) {
        ...
        if (splice == "window") {
          set <-
            c(
              set,
              set[length(set)] * wgeksaqu(data, tT, t, wstart = tT, window) / wgeksaqu(data, tT, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "half") {
          set <-
            c(
              set,
              set[length(set)] * wgeksaqu(data, th, t, wstart = tT, window) / wgeksaqu(data, th, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "mean") {
          ...
          for (m in 1:(window - 1)) {
            ...
            tm <- substr(tm, 0, 7)
            var <-
              var * wgeksaqu(data, tm, t, wstart = tT, window) / wgeksaqu(data, tm, t1,
                wstart =
                  tT1, window
              )
          }
        ...
        if (splice == "window_published") {
          set <-
            c(set, set[length(set) + 1 - (window - 1)] * wgeksaqu(data, tT, t,
              wstart =
                tT, window
            ))
        }
        if (splice == "half_published") {
          set <-
            c(set, set[length(set) + 1 - floor(window / 2)] * wgeksaqu(data, th, t,
              wstart =
                tT, window
            ))
        }
      ...
      if (start <= wend) {
        ...
        if (splice == "window") {
          set <-
            c(
              set,
              set[length(set)] * geksaqi(data, tT, t, wstart = tT, window) / geksaqi(data, tT, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "half") {
          set <-
            c(
              set,
              set[length(set)] * geksaqi(data, th, t, wstart = tT, window) / geksaqi(data, th, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "mean") {
          ...
          for (m in 1:(window - 1)) {
            ...
            tm <- substr(tm, 0, 7)
            var <-
              var * geksaqi(data, tm, t, wstart = tT, window) / geksaqi(data, tm, t1,
                wstart =
                  tT1, window
              )
          }
        ...
        if (splice == "window_published") {
          set <-
            c(set, set[length(set) + 1 - (window - 1)] * geksaqi(data, tT, t,
              wstart =
                tT, window
            ))
        }
        if (splice == "half_published") {
          set <-
            c(set, set[length(set) + 1 - floor(window / 2)] * geksaqi(data, th, t,
              wstart =
                tT, window
            ))
        }
      ...
      if (start <= wend) {
        ...
        if (splice == "window") {
          set <-
            c(
              set,
              set[length(set)] * wgeksaqi(data, tT, t, wstart = tT, window) / wgeksaqi(data, tT, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "half") {
          set <-
            c(
              set,
              set[length(set)] * wgeksaqi(data, th, t, wstart = tT, window) / wgeksaqi(data, th, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "mean") {
          ...
          for (m in 1:(window - 1)) {
            ...
            tm <- substr(tm, 0, 7)
            var <-
              var * wgeksaqi(data, tm, t, wstart = tT, window) / wgeksaqi(data, tm, t1,
                wstart =
                  tT1, window
              )
          }
        ...
        if (splice == "window_published") {
          set <-
            c(set, set[length(set) + 1 - (window - 1)] * wgeksaqi(data, tT, t,
              wstart =
                tT, window
            ))
        }
        if (splice == "half_published") {
          set <-
            c(set, set[length(set) + 1 - floor(window / 2)] * wgeksaqi(data, th, t,
              wstart =
                tT, window
            ))
        }
      ...
      if (start <= wend) {
        ...
        if (splice == "window") {
          set <-
            c(
              set,
              set[length(set)] * geksgaqi(data, tT, t, wstart = tT, window) / geksgaqi(data, tT, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "half") {
          set <-
            c(
              set,
              set[length(set)] * geksgaqi(data, th, t, wstart = tT, window) / geksgaqi(data, th, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "mean") {
          ...
          for (m in 1:(window - 1)) {
            ...
            tm <- substr(tm, 0, 7)
            var <-
              var * geksgaqi(data, tm, t, wstart = tT, window) / geksgaqi(data, tm, t1,
                wstart =
                  tT1, window
              )
          }
        ...
        if (splice == "window_published") {
          set <-
            c(set, set[length(set) + 1 - (window - 1)] * geksgaqi(data, tT, t,
              wstart =
                tT, window
            ))
        }
        if (splice == "half_published") {
          set <-
            c(set, set[length(set) + 1 - floor(window / 2)] * geksgaqi(data, th, t,
              wstart =
                tT, window
            ))
        }
      ...
      if (start <= wend) {
        ...
        if (splice == "window") {
          set <-
            c(
              set,
              set[length(set)] * wgeksgaqi(data, tT, t, wstart = tT, window) / wgeksgaqi(data, tT, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "half") {
          set <-
            c(
              set,
              set[length(set)] * wgeksgaqi(data, th, t, wstart = tT, window) / wgeksgaqi(data, th, t1,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "mean") {
          ...
          for (m in 1:(window - 1)) {
            ...
            tm <- substr(tm, 0, 7)
            var <-
              var * wgeksgaqi(data, tm, t, wstart = tT, window) / wgeksgaqi(data, tm, t1,
                wstart =
                  tT1, window
              )
          }
        ...
        if (splice == "window_published") {
          set <-
            c(set, set[length(set) + 1 - (window - 1)] * wgeksgaqi(data, tT, t,
              wstart =
                tT, window
            ))
        }
        if (splice == "half_published") {
          set <-
            c(set, set[length(set) + 1 - floor(window / 2)] * wgeksgaqi(data, th, t,
              wstart =
                tT, window
            ))
        }
      ...
      if (start <= wend) {
        ...
        if (splice == "window") {
          set <-
            c(
              set,
              set[length(set)] * geksiqm(data, tT, t, r, wstart = tT, window) / geksiqm(data, tT, t1, r,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "half") {
          set <-
            c(
              set,
              set[length(set)] * geksiqm(data, th, t, r, wstart = tT, window) / geksiqm(data, th, t1, r,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "mean") {
          ...
          for (m in 1:(window - 1)) {
            ...
            tm <- substr(tm, 0, 7)
            var <-
              var * geksiqm(data, tm, t, r, wstart = tT, window) / geksiqm(data, tm, t1, r,
                wstart =
                  tT1, window
              )
          }
        ...
        if (splice == "window_published") {
          set <-
            c(set, set[length(set) + 1 - (window - 1)] * geksiqm(data, tT, t, r,
              wstart =
                tT, window
            ))
        }
        if (splice == "half_published") {
          set <-
            c(set, set[length(set) + 1 - floor(window / 2)] * geksiqm(data, th, t, r,
              wstart =
                tT, window
            ))
        }
      ...
      if (start <= wend) {
        ...
        if (splice == "window") {
          set <-
            c(
              set,
              set[length(set)] * geksqm(data, tT, t, r, wstart = tT, window) / geksqm(data, tT, t1, r,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "half") {
          set <-
            c(
              set,
              set[length(set)] * geksqm(data, th, t, r, wstart = tT, window) / geksqm(data, th, t1, r,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "mean") {
          ...
          for (m in 1:(window - 1)) {
            ...
            tm <- substr(tm, 0, 7)
            var <-
              var * geksqm(data, tm, t, r, wstart = tT, window) / geksqm(data, tm, t1, r,
                wstart =
                  tT1, window
              )
          }
        ...
        if (splice == "window_published") {
          set <-
            c(set, set[length(set) + 1 - (window - 1)] * geksqm(data, tT, t, r,
              wstart =
                tT, window
            ))
        }
        if (splice == "half_published") {
          set <-
            c(set, set[length(set) + 1 - floor(window / 2)] * geksqm(data, th, t, r,
              wstart =
                tT, window
            ))
        }
      ...
      if (start <= wend) {
        ...
        if (splice == "window") {
          set <-
            c(
              set,
              set[length(set)] * gekslm(data, tT, t, sigma, wstart = tT, window) / gekslm(data, tT, t1, sigma,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "half") {
          set <-
            c(
              set,
              set[length(set)] * gekslm(data, th, t, sigma, wstart = tT, window) / gekslm(data, th, t1, sigma,
                wstart =
                  tT1, window
              )
            )
        ...
        if (splice == "mean") {
          ...
          for (m in 1:(window - 1)) {
            ...
            tm <- substr(tm, 0, 7)
            var <-
              var * gekslm(data, tm, t, sigma, wstart = tT, window) / gekslm(data, tm, t1, sigma,
                wstart =
                  tT1, window
              )
          }
        ...
        if (splice == "window_published") {
          set <-
            c(set, set[length(set) + 1 - (window - 1)] * gekslm(data, tT, t, sigma,
              wstart =
                tT, window
            ))
        }
        if (splice == "half_published") {
          set <-
            c(set, set[length(set) + 1 - floor(window / 2)] * gekslm(data, th, t, sigma,
              wstart =
                tT, window
            ))
        }
